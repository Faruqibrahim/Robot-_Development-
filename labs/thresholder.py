...
file_name = "lab06/default_trackbar.txt"
...
def main():
    ...
    while True:
        ...
        frame_e = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
        ...
        thresholded = cv2.inRange(frame_e, lowerLimits, upperLimits)
        
        thresholded = cv2.bitwise_not(thresholded)
        img_r=cv2.rectangle(thresholded, (0, 0), (639, 0), (255, 255, 255), 2) 
        
        keypoints = detector.detect(img_r)
        
        img_new = cv2.drawKeypoints(frame_e, keypoints, None, (0, 225, 0), cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
