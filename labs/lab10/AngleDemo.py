...
x1 = float(input('Enter A vector x coordinate -- '))

y1 = float(input('Enter A vector y coordinate -- '))

x2 = float(input('Enter B vector x coordinate -- '))

y2 = float(input('Enter B vector y coordinate -- '))
